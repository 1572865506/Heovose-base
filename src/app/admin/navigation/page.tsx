...
export default function NavigationSettingsPage() {
  ...
  return (
    <div className="space-y-10 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <AdminPageHeader
        title="导航设置"
        subtitle="Management / Content / Navigation"
        icon={Compass}
        actions={
          <Button 
      ...
      <AdminTabs defaultValue="navbar" className="w-full">
        <AdminTabsList className="mb-8">
          <AdminTabsTrigger value="navbar">
            <Layers className="mr-2 h-4 w-4" /> 顶栏物理材质
          </AdminTabsTrigger>
          <AdminTabsTrigger value="mega-menu">
        ...
        <AdminTabsContent value="navbar" className="space-y-6 outline-none">
          <AdminFormSection
            title="材质与深度控制 (Material & Depth)"
            subtitle="定义顶栏在激活状态下的物理属性"
            icon={Layers}
          >
        ...
        <AdminTabsContent value="mega-menu" className="space-y-6 outline-none">
          <AdminFormSection
            title="巨型菜单排版 (Architecture)"
            subtitle="管理二级菜单的列数、间距与布局比例"
            icon={LayoutGrid}
          >
        ...
        <AdminTabsContent value="featured" className="space-y-6 outline-none">
          <AdminFormSection
            title="主推板块设置 (Featured Promo)"
            subtitle="配置二级菜单右侧的产品推广图册与下载链接"
            icon={Sparkles}
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
