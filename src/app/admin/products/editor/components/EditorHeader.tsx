...
const EditorHeader = memo(({
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between sticky top-[-40px] -mt-10 z-50 bg-card/90 backdrop-blur-xl py-2 border border-border/40 shadow-[0_20px_50px_rgba(0,0,0,0.12)] rounded-2xl px-8 relative mb-8">
      <div className="flex items-center gap-8 flex-1 min-w-0">
        <div className="flex items-center gap-4 shrink-0">
          <Button variant="ghost" size="icon" onClick={() => router.back()} className="rounded-2xl h-10 w-10 hover:bg-muted/40 hover:text-foreground transition-all duration-300">
        ...
        <div className="flex items-center gap-4 flex-1 min-w-0 max-w-4xl">
          <div className="space-y-1 w-[200px] shrink-0">
            <Label className="text-[8px] font-bold uppercase tracking-widest text-muted-foreground/60 pl-1">资源归属分类</Label>
          ...
          <div className="space-y-1 w-[280px] shrink-0">
            <Label className="text-[8px] font-bold uppercase tracking-widest text-muted-foreground/60 pl-1">资产唯一标识 (ID)</Label>
          ...
          <div className="space-y-1">
            <Label className="text-[8px] font-bold uppercase tracking-widest text-muted-foreground/60 pl-1">智译完整度诊断</Label>
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="flex items-center gap-2 cursor-help h-10 px-4 bg-muted/20 rounded-xl border border-border/30 hover:border-primary/20 transition-all">
          ...
          <div className="space-y-1 w-[140px] shrink-0">
            <Label className="text-[8px] font-bold uppercase tracking-widest text-muted-foreground/60 pl-1">发布状态 (Toggle)</Label>
            <button
