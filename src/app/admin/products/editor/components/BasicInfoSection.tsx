  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
      ...
      <div className="lg:col-span-5 space-y-10">
        <section className="bg-card/60 backdrop-blur-md rounded-[2.5rem] border border-border/30 p-10 space-y-8 shadow-[0_8px_30px_rgb(0,0,0,0.08)] relative group overflow-hidden h-full">
