    ...
    <footer className="bg-primary text-primary-foreground py-20">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Column 2: Wholesale Products */}
          <div>
            <h4 className="font-bold mb-8 text-white uppercase tracking-wider text-xs">{t.nav.wholesale}</h4>
          ...
          {/* Column 3: Project Products */}
          <div>
            <h4 className="font-bold mb-8 text-white uppercase tracking-wider text-xs">{t.nav.projects}</h4>
            <ul className="space-y-4 opacity-60 text-sm">
