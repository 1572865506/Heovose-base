...
export const TimelineNav = ({ activeSystem }: { activeSystem: string }) => {
  ...
  const adminSections = [
    ...
    { id: 'admin-shared-05', title: '05. 输入系统', icon: Terminal },
    { id: 'admin-shared-06', title: '06. 表格系统', icon: TableProperties },
    { id: 'admin-shared-07', title: '07. 标签徽章', icon: Tag },
    { id: 'admin-shared-08', title: '08. 树形结构', icon: Workflow },
    { id: 'admin-shared-09', title: '09. 分页系统', icon: LayoutGrid },
    { id: 'admin-shared-10', title: '10. 选项卡系统', icon: Layout },
    { id: 'admin-shared-11', title: '11. 反馈与加载', icon: Loader2 },
    { id: 'admin-shared-12', title: '12. 导航与展示', icon: Monitor },
    { id: 'admin-13', title: '13. AI 交互', icon: Sparkles },
    { id: 'admin-14', title: '14. 业务逻辑', icon: Cpu },
    { id: 'admin-15', title: '15. 看板度量', icon: Gauge },
    { id: 'admin-16', title: '16. 高级过滤', icon: Filter },
    { id: 'admin-17', title: '17. 详情面板', icon: Layout },
