...
export function GlobalMap({ locale, homeConfig }: GlobalMapProps) {
  ...
  const pins = useMemo(() => {
    ...
    return [
      ...
      { key: 'jakarta', style: { top: '65%', left: '72.5%' }, title: locs.jakarta.title, address: locs.jakarta.address, desc: locs.jakarta.desc, type: 'Factory', icon: Globe },
    ];
  }, [homeConfig, locale, t]);
